...
const buttonFilter = [
  {
    ...
    name: 'Price',
    options: [
      { value: '10-50', label: 'RM10 TO RM50' },
      { value: '51-100', label: 'RM51 TO RM100' },
      { value: '101-150', label: 'RM101 TO RM150' },
      { value: '151-200', label: 'RM151 TO RM200' },
      { value: '201-250', label: 'RM201 TO RM250' },
      { value: '250-more', label: 'RM250 TO MORE' },
    ],
  },
  {
    id: 'stock',
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
              ...
              <div className="lg:col-span-4 w-full">
                <div className='flex flex-wrap justify-center bg-white py-5 '>
                  {mens_stuff.map((item) => <ProductCard product={item} />)}
                </div>
